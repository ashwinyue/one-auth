...
CREATE TABLE `menus`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_menu_code_tenant`(`menu_code`, `tenant_id`) USING BTREE,
  INDEX `idx_tenant_id`(`tenant_id`) USING BTREE,
...
-- Records of menus
-- ----------------------------
INSERT INTO `menus` VALUES (1, 1, NULL, 'dashboard', '仪表板', 2, '/dashboard', 'Dashboard', 'dashboard', 1, 1, 1, NULL, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `menus` VALUES (2, 1, NULL, 'system', '系统管理', 1, '/system', 'Layout', 'setting', 100, 1, 1, NULL, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `menus` VALUES (3, 1, NULL, 'user-manage', '用户管理', 1, '/user', 'Layout', 'user', 200, 1, 1, NULL, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `menus` VALUES (4, 1, 2, 'menu-manage', '菜单管理', 2, '/system/menu', 'system/Menu', 'menu', 101, 1, 1, NULL, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `menus` VALUES (5, 1, 2, 'role-manage', '角色管理', 2, '/system/role', 'system/Role', 'peoples', 102, 1, 1, NULL, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `menus` VALUES (6, 1, 2, 'permission-manage', '权限管理', 2, '/system/permission', 'system/Permission', 'lock', 103, 1, 1, NULL, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `menus` VALUES (7, 1, 2, 'tenant-manage', '租户管理', 2, '/system/tenant', 'system/Tenant', 'office-building', 104, 1, 1, NULL, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `menus` VALUES (8, 1, 3, 'user-list', '用户列表', 2, '/user/list', 'user/List', 'user', 201, 1, 1, NULL, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `menus` VALUES (9, 1, 3, 'user-profile', '个人资料', 2, '/user/profile', 'user/Profile', 'user-filled', 202, 1, 1, NULL, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
...
CREATE TABLE `permissions`  (
  ...
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `permission_code` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '权限编码（格式：module:action）',
  ...
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '删除时间（软删除）',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_permission_code_tenant`(`permission_code`, `tenant_id`) USING BTREE,
  INDEX `idx_tenant_id`(`tenant_id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `permissions` VALUES (1, 1, 'user:view', '查看用户', '查看用户列表和详情', 'menu', NULL, NULL, 'view', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (2, 1, 'user:create', '创建用户', '创建新用户', 'menu', NULL, NULL, 'create', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (3, 1, 'user:update', '编辑用户', '修改用户信息', 'menu', NULL, NULL, 'update', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (4, 1, 'user:delete', '删除用户', '删除用户账号', 'menu', NULL, NULL, 'delete', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (5, 1, 'user:export', '导出用户', '导出用户数据', 'feature', NULL, NULL, 'export', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (6, 1, 'role:view', '查看角色', '查看角色列表和详情', 'menu', NULL, NULL, 'view', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (7, 1, 'role:create', '创建角色', '创建新角色', 'menu', NULL, NULL, 'create', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (8, 1, 'role:update', '编辑角色', '修改角色信息', 'menu', NULL, NULL, 'update', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (9, 1, 'role:delete', '删除角色', '删除角色', 'menu', NULL, NULL, 'delete', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (10, 1, 'role:assign', '分配角色', '为用户分配角色', 'feature', NULL, NULL, 'assign', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (11, 1, 'permission:view', '查看权限', '查看权限列表', 'menu', NULL, NULL, 'view', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (12, 1, 'permission:assign', '分配权限', '为角色分配权限', 'feature', NULL, NULL, 'assign', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (13, 1, 'menu:view', '查看菜单', '查看菜单列表', 'menu', NULL, NULL, 'view', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (14, 1, 'menu:create', '创建菜单', '创建新菜单', 'menu', NULL, NULL, 'create', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (15, 1, 'menu:update', '编辑菜单', '修改菜单信息', 'menu', NULL, NULL, 'update', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (16, 1, 'menu:delete', '删除菜单', '删除菜单', 'menu', NULL, NULL, 'delete', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (17, 1, 'tenant:view', '查看租户', '查看租户信息', 'menu', NULL, NULL, 'view', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (18, 1, 'tenant:switch', '切换租户', '切换工作租户', 'feature', NULL, NULL, 'switch', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (19, 1, 'dashboard:view', '查看仪表板', '访问系统仪表板', 'menu', NULL, NULL, 'view', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (20, 1, 'profile:view', '查看个人资料', '查看个人信息', 'menu', NULL, NULL, 'view', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `permissions` VALUES (21, 1, 'profile:update', '编辑个人资料', '修改个人信息', 'menu', NULL, NULL, 'update', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '博文表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `role_permissions`  (
  ...
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '删除时间（软删除）',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_role_permission_tenant`(`role_id`, `permission_id`, `tenant_id`) USING BTREE,
  INDEX `idx_role_id`(`role_id`) USING BTREE,
  INDEX `idx_permission_id`(`permission_id`) USING BTREE,
  INDEX `idx_tenant_id`(`tenant_id`) USING BTREE,
  INDEX `idx_deleted_at`(`deleted_at`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色权限关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of role_permissions
-- ----------------------------
INSERT INTO `role_permissions` VALUES (1, 1, 1, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (2, 1, 2, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (3, 1, 3, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (4, 1, 4, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (5, 1, 5, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (6, 1, 6, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (7, 1, 7, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (8, 1, 8, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (9, 1, 9, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (10, 1, 10, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (11, 1, 11, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (12, 1, 12, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (13, 1, 13, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (14, 1, 14, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (15, 1, 15, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (16, 1, 16, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (17, 1, 17, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (18, 1, 18, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (19, 1, 19, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (20, 1, 20, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (21, 1, 21, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (32, 2, 19, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (33, 2, 13, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (34, 2, 21, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (35, 2, 20, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (36, 2, 6, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (37, 2, 2, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (38, 2, 3, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (39, 2, 1, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (47, 3, 19, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (48, 3, 21, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `role_permissions` VALUES (49, 3, 20, 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
...
CREATE TABLE `roles`  (
  ...
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '删除时间（软删除）',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_role_code_tenant`(`role_code`, `tenant_id`) USING BTREE,
  INDEX `idx_tenant_id`(`tenant_id`) USING BTREE,
  INDEX `idx_status`(`status`) USING BTREE,
  INDEX `idx_deleted_at`(`deleted_at`) USING BTREE
...
-- Records of roles
-- ----------------------------
INSERT INTO `roles` VALUES (1, 1, 'super_admin', '超级管理员', '超级管理员角色（不可删除）', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `roles` VALUES (2, 1, 'admin', '系统管理员', '拥有系统所有权限', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `roles` VALUES (3, 1, 'user', '普通用户', '普通用户权限', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `roles` VALUES (4, 2, 'super_admin', '超级管理员', '演示租户超级管理员', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `roles` VALUES (5, 2, 'admin', '租户管理员', '租户管理员权限', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
...
-- Records of tenants
-- ----------------------------
INSERT INTO `tenants` VALUES (1, 'default', '默认租户', '系统默认租户', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
INSERT INTO `tenants` VALUES (2, 'demo', '演示租户', '演示用租户', 1, '2025-06-15 15:34:40', '2025-06-15 15:34:40', NULL);
